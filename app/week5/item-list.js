...
export default function ItemList() {
    ...
    let items = Items.map((item) => ({ // create a new array of objects with the result of an original array of objects on each element
        key: item.id, //item. is from parameter (item) in map function
        name: item.name,
